...
LD_CKPT = "Drone_Agent/Run_20250715_133722_(M,N,K,L,FixEv,PLoS)=(16,64,3,1,True,False)/seed:200/model_at_K=3_L=1_200.pth"
...
def main():
    ...
    parser.add_argument("--lamda_init", type=float, default=0.0, help="Initial weight decay")
    parser.add_argument("--init_steps", type=int, default=1000, help="Init time steps")
    parser.add_argument("--init_batch", type=int, default=64, help="Init batch size for the batch scheduler")
    parser.add_argument("--init_noise", type=float, default=0.15, help="Init noise STD")
    parser.add_argument("--h_dims", type=int, default=512, help="First layer h_dims")
    parser.add_argument("--max_episodes", type=int, default=20, help="Maximum number of episodes")
    ...
    for seed in args.seed:
        ...
        save_dir = f"Drone_Agent/Resume_Training:Run_{timestamp}_(M,N,K,L,FixEv,PLoS)=({args.M},{args.N},{args.num_users},{args.num_eves},{args.fixed_eve},{args.los})/seed:{seed}"
        ...
        avris_agent.load_checkpoint(LD_CKPT)
